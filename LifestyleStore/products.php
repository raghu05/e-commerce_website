...
<html>
    ...
    <body style="color:rgb(255, 204, 141);">
        <div style="background-color:#FFF1DC;">
            <?php
                require 'header.php';
            ?>
            <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/watch1.jpg" alt="Titan 301">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">RADO CAPTAIN</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 130000.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/watch5.jpeg" alt="Titan 201">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">RADO MECHANICAL</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 300000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/watch41.jpeg" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">RADO CLASSIC</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 800000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/watch21.jpeg" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">RADO COOK</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 180000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/shirt1.jpeg" alt="Raymond shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">Raymond</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 15000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/shirt2.jpeg" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">GUCCI</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 50000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            <a href="cart.php">
                                <img src="img/shirt3.jpeg" alt="HXR">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">LOUIS VUITTON</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 90000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color: black;">
                            <a href="cart.php">
                                <img src="img/shirt4.jpeg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">RAJWADA</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 1200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6" >
                        <div class="thumbnail" style="background-color:black;">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">Cannon EOS</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 36000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">Sony DSLR</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 40000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail" style="background-color:black;">
                            ...
                            <center>
                                <div class="caption">
                                    <h3 style="color:rgb(255, 204, 141);">Olympus DSLR</h3>
                                    <p style="color:rgb(255, 204, 141);">Price: Rs. 80000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
