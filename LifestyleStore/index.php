           ...
           <div class="container"  >
               <div class="row">
                   <div class="col-xs-4" >
                       <div  class="thumbnail" >
                           <a href="products.php">
                                <img src="img/sony_dslr.jpeg" alt="Camera">
                           </a>
                           <center>
                                <div class="caption">
                   ...
                   <div class="col-xs-4">
                       <div class="thumbnail">
                           <a href="products.php">
                               <img src="img/watch21.jpeg" alt="Watch">
                           </a>
                           <center>
                                <div class="caption">
                   ...
                   <div class="col-xs-4">
                       <div class="thumbnail">
                           <a href="products.php">
                               <img src="img/shirt1.jpeg" alt="Shirt">
                           </a>
                           <center>
                               <div class="caption">
            ...
            <br><br> <br><br><br><br>
           <footer class="footer"> 
               <div class="container" style="color:rgb(255, 204, 141);">
               <center>
